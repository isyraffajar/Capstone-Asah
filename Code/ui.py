...
page = st.sidebar.selectbox("Choose your page", ["Home", "Data Exploration", "Modeling", "Insights", "Try Model"])
...
if page == "Home":
    ...
    *3. Distribusi Monetary (Moneter)*
    ...
    FILE_MODEL = 'Model/model_clustering.pkl'
    FILE_SCALER = 'Model/scaler.pkl'
